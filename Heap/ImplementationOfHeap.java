...
public class MinHeap {
    ...
    public void add(int element) {
        ...
        while ( minHeap[index] < minHeap[parent] && index > 1 ) {
            System.out.println(index+""+parent+" "+"index and parent"+minHeap[index]+" "+minHeap[parent]);
            int temp = minHeap[index];
            minHeap[index] = minHeap[parent];
            minHeap[parent] = temp;
            index = parent;
            parent = index / 2;
                        System.out.println("index and parent"+index+" "+parent+""+minHeap[index]+" "+minHeap[parent]);
